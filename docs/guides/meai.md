...
The Withings SDK provides integration with [Microsoft.Extensions.AI](https://learn.microsoft.com/en-us/dotnet/ai/microsoft-extensions-ai), enabling seamless interoperability with the unified .NET AI abstractions.

## Installation

```bash
dotnet add package Withings
```
...
using var client = new WithingsClient(
    apiKey: Environment.GetEnvironmentVariable("WITHINGS_API_KEY")!);
