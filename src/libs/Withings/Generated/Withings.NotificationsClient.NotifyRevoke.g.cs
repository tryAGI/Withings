...
namespace Withings
{
    public partial class NotificationsClient
    {
        ...
        {
            var __response = await NotifyRevokeAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Withings.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Withings.AutoSDKHttpResponse<global::Withings.SuccessResponse>> NotifyRevokeAsResponseAsync(
