...
namespace Withings
{
    public partial class NotificationsClient
    {
        ...
        private static readonly global::Withings.EndPointSecurityRequirement s_NotifySubscribeSecurityRequirement0 =
        ...
        private static readonly global::Withings.EndPointSecurityRequirement[] s_NotifySubscribeSecurityRequirements =
            new global::Withings.EndPointSecurityRequirement[]
            {                s_NotifySubscribeSecurityRequirement0,
            };
        partial void PrepareNotifySubscribeArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Withings.NotifySubscribeRequest request);
        partial void PrepareNotifySubscribeRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Withings.NotifySubscribeRequest request);
        partial void ProcessNotifySubscribeResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessNotifySubscribeResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Withings.SuccessResponse> NotifySubscribeAsync(

            global::Withings.NotifySubscribeRequest request,
            global::Withings.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await NotifySubscribeAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Withings.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Withings.AutoSDKHttpResponse<global::Withings.SuccessResponse>> NotifySubscribeAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareNotifySubscribeArguments(
            ...
            var __authorizations = global::Withings.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_NotifySubscribeSecurityRequirements,
                operationName: "NotifySubscribeAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Withings.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Withings.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "NotifySubscribeAsync",
                                pathTemplate: "\"/v2/notify-subscribe\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessNotifySubscribeResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Withings.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessNotifySubscribeResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Withings.SuccessResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Withings.AutoSDKHttpResponse<global::Withings.SuccessResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Withings.SuccessResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Withings.SuccessResponse> NotifySubscribeAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Withings.NotifySubscribeRequest
            {
                Action = action,
            ...
            return await NotifySubscribeAsync(
                request: __request,
                requestOptions: requestOptions,
