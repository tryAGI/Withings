...
namespace Withings
{
    public partial class SleepClient
    {
        ...
        {
            var __response = await Sleepv2GetAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Withings.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Withings.AutoSDKHttpResponse<global::Withings.SleepGetResponse>> Sleepv2GetAsResponseAsync(
                    ...
                    await global::Withings.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Withings.SleepGetResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Withings.AutoSDKHttpResponse<global::Withings.SleepGetResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Withings.SleepGetResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
