...
namespace Withings
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Withings.AutoSDKRetryOptions Retry { get; set; } = new global::Withings.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Withings.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Withings.IAutoSDKHook>();
        ...
        public global::Withings.AutoSDKClientOptions AddHook(
            global::Withings.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Withings.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Withings.AutoSDKClientOptions UseAuthorizationProvider(
            global::Withings.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Withings.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Withings.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Withings.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Withings.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Withings.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Withings.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Withings.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Withings.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Withings.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Withings.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Withings.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Withings.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Withings.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Withings.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Withings.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Withings.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Withings.AutoSDKClientOptions clientOptions,
            global::Withings.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Withings.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Withings.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Withings.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Withings.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Withings.IAutoSDKHook, global::Withings.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Withings.AutoSDKHookContext context)
        {
