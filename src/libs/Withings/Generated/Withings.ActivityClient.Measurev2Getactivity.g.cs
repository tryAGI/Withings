...
namespace Withings
{
    public partial class ActivityClient
    {
        ...
        {
            var __response = await Measurev2GetactivityAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Withings.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Withings.AutoSDKHttpResponse<global::Withings.GetActivityResponse>> Measurev2GetactivityAsResponseAsync(
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Withings.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Withings.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "Measurev2Getactivity",
                                methodName: "Measurev2GetactivityAsync",
                                pathTemplate: "\"/v2/measure\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::Withings.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Withings.GetActivityResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Withings.AutoSDKHttpResponse<global::Withings.GetActivityResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Withings.GetActivityResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
