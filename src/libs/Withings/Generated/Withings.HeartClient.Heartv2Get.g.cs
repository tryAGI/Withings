...
namespace Withings
{
    public partial class HeartClient
    {
        ...
        private static readonly global::Withings.EndPointSecurityRequirement s_Heartv2GetSecurityRequirement0 =
        ...
        private static readonly global::Withings.EndPointSecurityRequirement[] s_Heartv2GetSecurityRequirements =
            new global::Withings.EndPointSecurityRequirement[]
            {                s_Heartv2GetSecurityRequirement0,
            };
        partial void PrepareHeartv2GetArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Withings.Heartv2GetRequest request);
        partial void PrepareHeartv2GetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Withings.Heartv2GetRequest request);
        partial void ProcessHeartv2GetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessHeartv2GetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Withings.HeartGetResponse> Heartv2GetAsync(

            global::Withings.Heartv2GetRequest request,
            global::Withings.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await Heartv2GetAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Withings.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Withings.AutoSDKHttpResponse<global::Withings.HeartGetResponse>> Heartv2GetAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Withings.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_Heartv2GetSecurityRequirements,
                operationName: "Heartv2GetAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                         ...
                         __authorization.Location == "Header")
                {
                    __httpRequest.Headers.Add(__authorization.Name, __authorization.Value);
                            ...
                            __formValues.Add(new global::System.Collections.Generic.KeyValuePair<string, string>(
                                "signalid",
                                global::System.Convert.ToString(request.Signalid, global::System.Globalization.CultureInfo.InvariantCulture) ?? string.Empty));
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Withings.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Withings.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "Heartv2Get",
                                methodName: "Heartv2GetAsync",
                                pathTemplate: "\"/v2/heart-get\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Withings.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessHeartv2GetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Withings.HeartGetResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Withings.AutoSDKHttpResponse<global::Withings.HeartGetResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Withings.HeartGetResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Withings.HeartGetResponse> Heartv2GetAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Withings.Heartv2GetRequest
            {
                Action = action,
                Signalid = signalid,
            };

            return await Heartv2GetAsync(
                request: __request,
                requestOptions: requestOptions,
