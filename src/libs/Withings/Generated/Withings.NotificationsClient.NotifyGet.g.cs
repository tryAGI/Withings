...
namespace Withings
{
    public partial class NotificationsClient
    {
        ...
        {
            var __response = await NotifyGetAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Withings.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Withings.AutoSDKHttpResponse<global::Withings.NotifyListResponse>> NotifyGetAsResponseAsync(
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Withings.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Withings.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "NotifyGet",
                                methodName: "NotifyGetAsync",
                                pathTemplate: "\"/v2/notify-get\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
