...
namespace Withings
{
    public partial class SleepClient
    {
        ...
        private static readonly global::Withings.EndPointSecurityRequirement s_Sleepv2GetsummarySecurityRequirement0 =
        ...
        private static readonly global::Withings.EndPointSecurityRequirement[] s_Sleepv2GetsummarySecurityRequirements =
            new global::Withings.EndPointSecurityRequirement[]
            {                s_Sleepv2GetsummarySecurityRequirement0,
            };
        ...
        {
            var __response = await Sleepv2GetsummaryAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Withings.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Withings.AutoSDKHttpResponse<global::Withings.SleepGetSummaryResponse>> Sleepv2GetsummaryAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Withings.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_Sleepv2GetsummarySecurityRequirements,
                operationName: "Sleepv2GetsummaryAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                         ...
                         __authorization.Location == "Header")
                {
                    __httpRequest.Headers.Add(__authorization.Name, __authorization.Value);
                            ...
                            if (request.Startdateymd != default)
                            {
                                __formValues.Add(new global::System.Collections.Generic.KeyValuePair<string, string>(
                                    "startdateymd",
                                    request.Startdateymd ?? string.Empty));
                            }
                            if (request.Enddateymd != default)
                            {
                                __formValues.Add(new global::System.Collections.Generic.KeyValuePair<string, string>(
                                    "enddateymd",
                                    request.Enddateymd ?? string.Empty));
                            }
                            if (request.Lastupdate != default)
                            {
                                __formValues.Add(new global::System.Collections.Generic.KeyValuePair<string, string>(
                                    "lastupdate",
                                    global::System.Convert.ToString(request.Lastupdate, global::System.Globalization.CultureInfo.InvariantCulture) ?? string.Empty));
                            }
                            ...
                            if (request.DataFields != default)
                            {
                                __formValues.Add(new global::System.Collections.Generic.KeyValuePair<string, string>(
                                    "data_fields",
                                    request.DataFields ?? string.Empty));
                            }
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Withings.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Withings.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "Sleepv2Getsummary",
                                methodName: "Sleepv2GetsummaryAsync",
                                pathTemplate: "\"/v2/sleep-getsummary\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::Withings.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Withings.SleepGetSummaryResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Withings.AutoSDKHttpResponse<global::Withings.SleepGetSummaryResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Withings.SleepGetSummaryResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
